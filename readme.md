...
> This is a project that uses an API to display movies and uses Involvement API also to show display comments on it
...
> Display the movie,
> Uses involvement API to diplay comments
...
` git clone https://github.com/ernestkorir/movie-shop.git`
...
Feel free to check the [issues page](https://github.com/ernestkorir/movie-shop/issues).
